  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="bg-card p-8 rounded-lg border border-border">
      <div className="grid grid-cols-2 gap-6 mb-6">
        {/* SKU */}
        <div>
          <label htmlFor="edit_sku" className="block text-foreground mb-2">SKU *</label>
          <input
            id="edit_sku"
            {...register('sku')}
        ...
        {/* Category */}
        <div>
          <label htmlFor="edit_category" className="block text-foreground mb-2">Kategoria *</label>
          <select
            id="edit_category"
            {...register('category')}
        ...
        <div className="col-span-2">
          <label htmlFor="edit_name" className="block text-foreground mb-2">Nazwa *</label>
          <input
            id="edit_name"
            {...register('name')}
            className="w-full px-4 py-3 rounded-lg bg-muted border border-border text-foreground focus:border-violet-500 focus:outline-none"
        ...
        {/* Quantity */}
        <div>
          <label htmlFor="edit_quantity" className="block text-foreground mb-2">Ilość *</label>
          <input
            id="edit_quantity"
        ...
        {/* Unit */}
        <div>
          <label htmlFor="edit_unit" className="block text-foreground mb-2">Jednostka *</label>
          <input
            id="edit_unit"
            {...register('unit')}
            className="w-full px-4 py-3 rounded-lg bg-muted border border-border text-foreground focus:border-violet-500 focus:outline-none"
        ...
        {/* Low Stock Threshold */}
        <div>
          <label htmlFor="edit_low_stock_threshold" className="block text-foreground mb-2">Próg niskiego stanu *</label>
          <input
        ...
        {/* Location */}
        <div>
          <label htmlFor="edit_location" className="block text-foreground mb-2">Lokalizacja</label>
          <input
            id="edit_location"
            {...register('location')}
            className="w-full px-4 py-3 rounded-lg bg-muted border border-border text-foreground focus:border-violet-500 focus:outline-none"
        ...
        {/* Supplier */}
        <div>
          <label htmlFor="edit_supplier" className="block text-foreground mb-2">Dostawca</label>
          <input
            id="edit_supplier"
            {...register('supplier')}
            className="w-full px-4 py-3 rounded-lg bg-muted border border-border text-foreground focus:border-violet-500 focus:outline-none"
        ...
        {showPrices && (
          <div>
            <label htmlFor="edit_unit_cost" className="block text-foreground mb-2">Koszt jednostkowy (PLN)</label>
            <input
              id="edit_unit_cost"
        ...
        {/* Batch Number */}
        <div>
          <label htmlFor="edit_batch_number" className="block text-foreground mb-2">Numer partii/serii</label>
          <input
        ...
        {/* Expiry Date */}
        <div>
          <label htmlFor="edit_expiry_date" className="block text-foreground mb-2">Data ważności</label>
          <input
            id="edit_expiry_date"
        ...
        {/* Description */}
        <div className="col-span-2">
          <label htmlFor="edit_description" className="block text-foreground mb-2">Opis</label>
          <textarea
            id="edit_description"

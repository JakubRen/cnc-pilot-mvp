        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 overflow-hidden">
          <div className="p-6 border-b border-slate-200 dark:border-slate-700">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-sm text-slate-500 dark:text-slate-400 mb-1">Order</div>
                <Link
          ...
          <div className="p-6 space-y-6">
            {/* Time Information */}
            <div>
              <h3 className="text-lg font-semibold mb-4 text-slate-700 dark:text-slate-300">Time Information</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <div className="text-sm text-slate-500 dark:text-slate-400 mb-1">Start Time</div>
                  <div className="font-medium">{formatDateTime(timeLog.start_time)}</div>
                </div>
                <div>
                  <div className="text-sm text-slate-500 dark:text-slate-400 mb-1">End Time</div>
            ...
            <PermissionGuard prices="time-tracking">
              <div>
                <h3 className="text-lg font-semibold mb-4 text-slate-700 dark:text-slate-300">Informacje o kosztach</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <div className="text-sm text-slate-500 dark:text-slate-400 mb-1">Stawka godzinowa</div>
                    <div className="font-medium text-xl">
                      <PriceDisplay
                  ...
                  <div>
                    <div className="text-sm text-slate-500 dark:text-slate-400 mb-1">Całkowity koszt</div>
            ...
            <div>
              <h3 className="text-lg font-semibold mb-4 text-slate-700 dark:text-slate-300">Operator Information</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <div className="text-sm text-slate-500 dark:text-slate-400 mb-1">Operator Name</div>
                ...
                <div>
                  ...
                  <div className="font-medium text-slate-700 dark:text-slate-300">{(timeLog.users as unknown as { email: string }).email}</div>
                </div>
              </div>
            </div>
            ...
            {timeLog.notes && (
              <div>
                <h3 className="text-lg font-semibold mb-4 text-slate-700 dark:text-slate-300">Notes</h3>
                <div className="bg-slate-100 dark:bg-slate-700 rounded-lg p-4">
                  <p className="text-slate-700 dark:text-slate-300">{timeLog.notes}</p>
                </div>
              </div>
            )}
            ...
            {/* Audit Trail */}
            <div>
              <h3 className="text-lg font-semibold mb-4 text-slate-700 dark:text-slate-300">Audit Trail</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                  <div className="text-slate-500 dark:text-slate-400 mb-1">Created At</div>
                  <div className="text-slate-700 dark:text-slate-300">{formatDateTime(timeLog.created_at)}</div>
                </div>
                <div>
                  <div className="text-slate-500 dark:text-slate-400 mb-1">Last Updated</div>
                  <div className="text-slate-700 dark:text-slate-300">{formatDateTime(timeLog.updated_at)}</div>
                </div>
              </div>
            </div>
          </div>

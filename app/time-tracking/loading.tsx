  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Filters Skeleton */}
        <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-4 mb-6 animate-pulse">
            ...
            >
              <div className="flex justify-between items-start mb-4">
                <div className="space-y-2 flex-1">
                  ...
                  <div className="h-4 bg-slate-200 dark:bg-slate-700 rounded w-60"></div>
                </div>
                <div className="h-8 bg-slate-200 dark:bg-slate-700 rounded w-24"></div>
              </div>
              <div className="flex gap-4">
                {[...Array(4)].map((_, j) => (
                  <div key={j} className="h-4 bg-slate-200 dark:bg-slate-700 rounded w-20"></div>
                ))}
              </div>
            </div>
          ))}

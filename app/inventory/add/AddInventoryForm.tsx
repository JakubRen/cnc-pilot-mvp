  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="bg-card p-8 rounded-lg border border-border">
      <div className="grid grid-cols-2 gap-6 mb-6">
        {/* SKU */}
        <div>
          <label htmlFor="sku" className="block text-foreground mb-2">{t('inventory', 'sku')} *</label>
          <input
            id="sku"
            autoFocus
            {...register('sku')}
        ...
        {/* Category */}
        <div>
          <label htmlFor="category" className="block text-foreground mb-2">{t('inventory', 'category')} *</label>
          <select
            id="category"
            {...register('category')}
        ...
        <div className="col-span-2">
          <label htmlFor="name" className="block text-foreground mb-2">{t('common', 'name')} *</label>
          <input
            id="name"
            {...register('name')}
        ...
        {/* Quantity */}
        <div>
          <label htmlFor="quantity" className="block text-foreground mb-2">{t('common', 'quantity')} *</label>
          <input
            id="quantity"
        ...
        {/* Unit */}
        <div>
          <label htmlFor="unit" className="block text-foreground mb-2">{t('inventory', 'unit')} *</label>
          <input
            id="unit"
            {...register('unit')}
        ...
        {/* Low Stock Threshold */}
        <div>
          <label htmlFor="low_stock_threshold" className="block text-foreground mb-2">{t('inventory', 'lowStockThreshold')} *</label>
          <input
        ...
        {/* Location */}
        <div>
          <label htmlFor="location" className="block text-foreground mb-2">{t('inventory', 'location')}</label>
          <input
            id="location"
            {...register('location')}
        ...
        {/* Supplier */}
        <div>
          <label htmlFor="supplier" className="block text-foreground mb-2">{t('inventory', 'supplier')}</label>
          <input
            id="supplier"
            {...register('supplier')}
        ...
        {showPrices && (
          <div>
            <label htmlFor="unit_cost" className="block text-foreground mb-2">{t('inventory', 'unitCost')}</label>
            <input
              id="unit_cost"
        ...
        {/* Batch Number */}
        <div>
          <label htmlFor="batch_number" className="block text-foreground mb-2">{t('inventory', 'batchNumber')}</label>
          <input
            id="batch_number"
        ...
        {/* Expiry Date */}
        <div>
          <label htmlFor="expiry_date" className="block text-foreground mb-2">{t('inventory', 'expiryDate')}</label>
          <input
            id="expiry_date"
        ...
        {/* Description */}
        <div className="col-span-2">
          <label htmlFor="description" className="block text-foreground mb-2">{t('common', 'description')}</label>
          <textarea
            id="description"
        ...
        {/* Notes */}
        <div className="col-span-2">
          <label htmlFor="notes" className="block text-foreground mb-2">{t('common', 'notes')}</label>
          <textarea
            id="notes"
            {...register('notes')}
            rows={2}
      ...
      <div className="flex gap-4 pt-4">
        <Button
          ...
          className="flex-1 py-3 bg-violet-600 text-white rounded-lg hover:bg-violet-700 font-semibold transition"
        >
        ...
        <Button
          ...
          className="px-8 py-3 bg-muted text-foreground rounded-lg hover:bg-slate-50 dark:hover:bg-slate-600 transition"
        >
          {t('common', 'cancel')}
        </Button>
      </div>

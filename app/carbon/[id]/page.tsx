      ...
      <div className="p-8">
        <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-6">
              ...
              <dl className="space-y-3">
                <div className="flex justify-between">
                  <dt className="text-slate-500 dark:text-slate-400">Nazwa produktu</dt>
                  <dd className="text-slate-900 dark:text-white font-medium">{report.product_name}</dd>
                </div>
                <div className="flex justify-between">
                  <dt className="text-slate-500 dark:text-slate-400">Ilość</dt>
                ...
                {report.orders && (
                  <>
                    <div className="flex justify-between">
                      <dt className="text-slate-500 dark:text-slate-400">Nr zamówienia</dt>
                      <dd className="text-slate-900 dark:text-white font-medium">{report.orders.order_number}</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-slate-500 dark:text-slate-400">Klient</dt>
            ...
            <div className="bg-gradient-to-r from-green-900/30 to-emerald-900/30 border border-green-700/50 rounded-lg p-6">
              ...
              <div className="space-y-4">
                <div className="text-center py-4">
                  <p className="text-slate-500 dark:text-slate-400 text-sm mb-1">Całkowita emisja CO₂</p>
                ...
                <div className="border-t border-green-700/30 pt-4">
                  <div className="flex justify-between text-sm">
                    <span className="text-slate-500 dark:text-slate-400">Emisja na jednostkę</span>
          ...
          <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-6 mb-8">
            <h2 className="text-lg font-semibold text-slate-900 dark:text-white mb-4">Szczegóły obliczenia</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-slate-50 dark:bg-slate-900 rounded-lg p-4">
                ...
                {report.material_name ? (
                  <dl className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      <dt className="text-slate-500 dark:text-slate-400">Materiał</dt>
                      <dd className="text-slate-900 dark:text-white">{report.material_name}</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-slate-500 dark:text-slate-400">Waga</dt>
                      <dd className="text-slate-900 dark:text-white">{report.material_weight_kg} kg</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-slate-500 dark:text-slate-400">Wsp. emisji</dt>
                      <dd className="text-slate-900 dark:text-white">{report.material_emission_factor} kg CO₂/kg</dd>
                    </div>
                    <div className="flex justify-between pt-2 border-t border-slate-200 dark:border-slate-700">
                      <dt className="text-slate-700 dark:text-slate-300 font-medium">Emisja</dt>
              ...
              <div className="bg-slate-50 dark:bg-slate-900 rounded-lg p-4">
                ...
                {report.energy_kwh ? (
                  <dl className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      <dt className="text-slate-500 dark:text-slate-400">Zużycie energii</dt>
                      <dd className="text-slate-900 dark:text-white">{report.energy_kwh} kWh</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-slate-500 dark:text-slate-400">Wsp. emisji</dt>
                      <dd className="text-slate-900 dark:text-white">{report.energy_emission_factor} kg CO₂/kWh</dd>
                    </div>
                    <div className="flex justify-between pt-2 border-t border-slate-200 dark:border-slate-700">
                      <dt className="text-slate-700 dark:text-slate-300 font-medium">Emisja</dt>
                      <dd className="text-green-400 font-semibold">
            ...
            <div className="mt-6 pt-4 border-t border-slate-200 dark:border-slate-700">
              <p className="text-slate-500 dark:text-slate-400 text-sm mb-2">Zastosowana formuła:</p>
          ...
          {/* Metadata */}
          <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-6">
            <h2 className="text-lg font-semibold text-slate-900 dark:text-white mb-4">Dane dokumentu</h2>
            <dl className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              <div>
                <dt className="text-slate-500 dark:text-slate-400">Numer raportu</dt>
                <dd className="text-slate-900 dark:text-white font-medium">{report.report_number}</dd>
              </div>
              <div>
                <dt className="text-slate-500 dark:text-slate-400">Data utworzenia</dt>
                <dd className="text-slate-900 dark:text-white font-medium">{createdAt}</dd>
              </div>
              <div>
                <dt className="text-slate-500 dark:text-slate-400">Utworzony przez</dt>
                <dd className="text-slate-900 dark:text-white font-medium">{creatorName || '—'}</dd>
              </div>
              <div>
                <dt className="text-slate-500 dark:text-slate-400">Metoda obliczeń</dt>
            ...
            {report.notes && (
              <div className="mt-4 pt-4 border-t border-slate-200 dark:border-slate-700">
                <p className="text-slate-500 dark:text-slate-400 text-sm">Uwagi:</p>

        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <h1 className="text-3xl font-bold text-white">Kooperanci</h1>
              <p className="text-slate-400 mt-1">Zarządzaj zewnętrznymi dostawcami usług</p>
            </div>
          ...
          {!cooperantStats || cooperantStats.length === 0 ? (
            <div className="bg-slate-800 border border-slate-700 rounded-lg p-12 text-center">
              ...
              <h2 className="text-xl font-semibold text-white mb-2">Brak kooperantów</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {cooperantStats.map((coop) => (
                <div
                  key={coop.id}
                  className={`bg-slate-800 border rounded-lg p-6 ${coop.is_active ? 'border-slate-700' : 'border-slate-600 opacity-60'}`}
                >
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <h3 className="text-xl font-semibold text-white">{coop.name}</h3>
                  ...
                  <div className="flex justify-between items-center pt-4 border-t border-slate-700">
                    <div className="flex gap-4 text-sm">
                      <span className="text-slate-400">
                        Wszystkie: <span className="text-white font-semibold">{coop.totalOperations}</span>
                      </span>
                      <span className="text-slate-400">

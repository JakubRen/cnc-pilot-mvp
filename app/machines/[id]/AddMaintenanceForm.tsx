    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="md:col-span-2">
          <label className="block text-foreground mb-2 text-sm">Tytuł *</label>
          <Input
            value={title}
        ...
        <div>
          <label className="block text-foreground mb-2 text-sm">Typ</label>
          <select
            value={type}
        ...
        <div>
          <label className="block text-foreground mb-2 text-sm">Serwisant zewnętrzny</label>
          <Input
        ...
        <div className="md:col-span-2">
          <label className="block text-foreground mb-2 text-sm">Opis</label>
          <textarea
            value={description}
        ...
        <div>
          <label className="block text-foreground mb-2 text-sm">Godziny pracy</label>
          <Input
            type="number"
            step="0.5"
            min="0"
        ...
        <div>
          <label className="block text-foreground mb-2 text-sm">Koszt części (PLN)</label>
          <Input
            type="number"
            step="0.01"
            min="0"
        ...
        <div>
          <label className="block text-foreground mb-2 text-sm">Koszt robocizny (PLN)</label>
          <Input
            type="number"
            step="0.01"
            min="0"
        ...
        <div className="flex items-center">
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              ...
              className="w-4 h-4 rounded border-border bg-muted text-violet-600 focus:ring-violet-500"
            />
            <span className="text-foreground text-sm">Oznacz jako ukończone</span>
          </label>
        </div>
      </div>

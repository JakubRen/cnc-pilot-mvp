      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <h1 className="text-4xl font-bold text-slate-900 dark:text-white">Raport Kontroli Jakości</h1>
            <p className="text-slate-500 dark:text-slate-400 mt-1">Plany kontroli, pomiary, statystyki</p>
          </div>

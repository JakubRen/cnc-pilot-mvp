    ...
    <header className="bg-slate-800 border-b border-slate-700 px-6 py-4 flex items-center justify-between">
      ...
      <div className="relative" ref={dropdownRef}>
        <button
          ...
          className="flex items-center gap-3 px-4 py-2 bg-slate-700 hover:bg-slate-600 rounded-lg transition-colors group"
        >
          {/* Avatar */}
        ...
        {isDropdownOpen && (
          <div className="absolute right-0 mt-2 w-56 bg-slate-700 border border-slate-600 rounded-lg shadow-xl z-50 overflow-hidden">
            ...
            <Link
              href="/profile"
              className="flex items-center gap-3 px-4 py-3 text-sm text-slate-300 hover:bg-slate-600 transition-colors"
            ...
            <Link
              href="/logout"
              className="flex items-center gap-3 px-4 py-3 text-sm text-red-400 hover:bg-red-600/20 transition-colors"
              onClick={() => setIsDropdownOpen(false)}
            >
              <span className="text-lg">🚪</span>
              <span>Wyloguj</span>

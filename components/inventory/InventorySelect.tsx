    ...
    <div ref={wrapperRef} className="relative">
      ...
      <div className="relative">
        <input
          ...
          disabled={loading}
          className={`w-full px-4 py-3 rounded-lg bg-slate-900 border text-white focus:outline-none transition ${
            error
              ...
              {filteredItems.map((item) => (
                <li key={item.id}>
                  <button
                    ...
                    className={`w-full px-4 py-3 text-left hover:bg-slate-700 transition flex justify-between items-center ${
                      inputValue === item.name ? 'bg-blue-600/20 text-blue-400' : 'text-white'
                    }`}
                  >
                    <div>

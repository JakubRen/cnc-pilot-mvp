    ...
    <div className="space-y-4">
      ...
      <div
        ...
        className={`border-2 border-dashed rounded-lg p-8 text-center transition cursor-pointer ${
          isDragActive
            ...
            : 'border-border hover:border-slate-400 dark:hover:border-slate-500 bg-muted'
      ...
      >
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          {uploading ? (
            <div>
              <p className="text-foreground font-medium">Przesyłanie plików...</p>
              <div className="mt-2 w-48 h-2 bg-muted rounded-full overflow-hidden">
                <div className="h-full bg-violet-500 animate-pulse" style={{ width: '50%' }} />
              </div>
            </div>
          ) : isDragActive ? (
            <p className="text-foreground font-medium">Upuść pliki tutaj...</p>
          ) : (
            <div>
      ...
      {acceptedFiles.length > 0 && !uploading && (
        <div className="bg-card border border-border rounded-lg p-4">
          <h4 className="text-foreground font-semibold mb-2">Wybrane pliki:</h4>

        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div className="bg-card border border-border rounded-lg p-6 max-w-lg w-full mx-4 shadow-2xl">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-foreground">Link do portalu klienta</h3>
              <button
            ...
            <p className="text-muted-foreground text-sm mb-4">
              Wyślij ten link do <span className="text-foreground font-medium">{customerName}</span>,
              aby mogli śledzić status swoich zamówień.
            </p>

            {/* Link Display */}
            <div className="bg-muted border border-border rounded-lg p-3 mb-4">
              <code className="text-violet-400 text-sm break-all">{portalUrl}</code>
            </div>

    ...
    <div className="relative" ref={dropdownRef}>
      ...
      <div className="flex flex-wrap gap-2 mb-2">
        {selectedTags.length === 0 ? (
          <span className="text-sm text-muted-foreground">{t('tagsSection', 'noTagsSelected')}</span>
        ) : (
      ...
      <button
        ...
        className="px-4 py-2 bg-muted hover:bg-accent text-foreground text-sm rounded-lg transition flex items-center gap-2"
      >
      ...
      {/* Dropdown */}
      {isOpen && (
        <div className="absolute z-10 mt-2 w-64 bg-card border border-border rounded-lg shadow-xl">
          {/* Search */}
          <div className="p-3 border-b border-border">
            <input
              ...
              className="w-full px-3 py-2 bg-muted border border-border rounded text-foreground text-sm placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-violet-500"
            />
          </div>
